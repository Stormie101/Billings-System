...
if ($conn->connect_error) {
    ...
    $sql = "INSERT INTO client_invoice (att, tel, email, ref, INo, Dates, Terms, SaleP, PO_no, LO_date, Pages, compName, compStreet, compCity, compState) VALUES ('$att', '$tel', '$email', '$reference', '$INo', '$Date', '$Terms', '$SaleP', '$Pnos', '$Ldates', '$Page', '$compName', '$compStreet', '$compCity', '$compState' )";
...
for ($i = 1; $i <= $numQuotations; $i++) {
    echo "<hr>";
    echo "<h5><b>INVOICE INPUT $i</b></h5>";
    echo "<table>";
    echo "<tr>";
