...
<header>
        ...
        <p style="font-size: 20px; padding-bottom: 15px; font-weight:bold;">Delivery Order Detail</p>
    </header>
...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $sql = "SELECT * FROM client_delivery WHERE id = $id"; // Adjust the query as per your database structure
    ...
    if ($result->num_rows > 0) {
        ...
        echo "<p class='quotation-details'><span>Invoice No :</span>" . $row["INo"] . "</p>";
